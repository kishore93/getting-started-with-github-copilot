...
activities = {
    ...
    "Soccer Team": {
        "description": "Team sport focused on strategy, fitness, and friendly competition",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice shooting, passing, and team coordination",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and performance skills",
        "schedule": "Tuesdays, Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["isabella@mergington.edu", "lucas@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build public speaking, argumentation, and critical reasoning skills",
